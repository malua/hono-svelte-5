// Generated by Wrangler by running `wrangler types --env-interface WorkerEnv ./src/lib/types/worker.d.ts` (hash: 1cf5f2cda98aa9522a29526c242cb5d7)
// Runtime types generated with workerd@1.20250409.0 2025-03-05 
declare namespace Cloudflare {
	interface Env {
		KVSoftwareList: KVNamespace;
		JWT_SECRET: string;
		INVITE_CODE: string;
		DB: D1Database;
	}
